...
class TransportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppShell(
      ...
      child: Column(
        children: [
          const PageHeader(title: 'Transport Services', subtitle: 'Safe, reliable, and GPS-tracked school transport'),
          SectionWrapper(
            backgroundColor: AppColors.white,
            child: isMobile
                ? Column(children: [_zonesTable(context), const SizedBox(height: 32), _safetyFeatures(context)])
                : Row(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: DataTable(
            ...
            headingTextStyle: GoogleFonts.nunitoSans(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13),
            ...
            rows: SchoolData.transportZones.map((z) => DataRow(cells: [
              DataCell(Text(z.zone, style: const TextStyle(fontWeight: FontWeight.w600, color: AppColors.navy))),
              DataCell(Text(z.area)),
              DataCell(Text(z.distance)),
              DataCell(Text('₹ ${z.fee}', style: const TextStyle(fontWeight: FontWeight.w600, color: AppColors.gold))),
            ])).toList(),
          ),
        ),
      ],
      ...
      children: [
        ...
        ...SchoolData.transportFeatures.map((f) => Container(
          ...
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Icon(Icons.verified_user, color: AppColors.gold, size: 18),
              const SizedBox(width: 12),
              Expanded(child: Text(f, style: GoogleFonts.nunitoSans(fontSize: 14, height: 1.4))),
            ],
          ),
        )),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Fleet Size', style: GoogleFonts.nunitoSans(
                    ...
                    Text(
                      ...
                      style: GoogleFonts.nunitoSans(color: AppColors.textPrimary, fontSize: 13, height: 1.5),
                    ),
                  ],
                ),
              ),
