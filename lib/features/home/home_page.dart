      ...
      child: Column(
        children: [
          ...
          CtaBanner(
            ...
            subtitle:
                'Join the Springfield family. Limited seats available across all grades.',
          ...
          Positioned.fill(
            child: Image.asset(
              ...
              errorBuilder: (_, __, ___) =>
                  const SizedBox(), // no photo yet → gradient shows
            ),
          ),
          // Dark overlay so text stays readable over the photo
          Positioned.fill(
            child: Container(color: AppColors.navyDark.withValues(alpha: 0.65)),
          ),
          // Decorative circle
          if (!isMobile)
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: AppColors.gold.withValues(alpha: 0.08), width: 2),
                ),
              ),
            ),
          // Content
    ...
    return Column(
      ...
      children: [
        Icon(Icons.format_quote,
            color: AppColors.gold.withValues(alpha: 0.4), size: 36),
